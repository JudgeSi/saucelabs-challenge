 ...
 *      underlying Resttemplate of the PingUtility is bound to the mockServer in the Test configuration.
 *
 ...
 */
@SpringBootTest
@TestPropertySource(properties = {"LOG_SEVERITY:DEBUG", "monitor.scheduling.enabled:false", "SUBJECT_URL:http://localhost:12345/", "REPORT_INTERVAL:10000"})
public class ServerMonitorIntegrationTests {
    ...
    public void monitorHandlesSuccessfullRequestCorrectly(){
        ...
        mockServer.expect(ExpectedCount.once(), requestTo("http://localhost:12345/"))
        ...
        assertEquals("http://localhost:12345/", ping.getDestination(), "An unexpected destination was written to the ping");
    ...
    public void healthIsCorrectForFiveFailedAndFiveSuccessfulPings(){
        ...
        mockServer.expect(ExpectedCount.times(5), requestTo("http://localhost:12345/"))
                .andExpect(method(HttpMethod.GET))
